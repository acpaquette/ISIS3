...
TEST(Thm2Isis, FunctionalTestsThm2isisVis) {
  ...
  std::unique_ptr<Histogram> hist (oddCube->histogram(0));
  ...
  hist.reset(oddCube->histogram(1));
  ...
  hist.reset(oddCube->histogram(2));
  ...
  hist.reset(oddCube->histogram(3));
  ...
  hist.reset(oddCube->histogram(4));
  ...
  hist.reset(oddCube->histogram(5));
  ...
  hist.reset(evenCube->histogram(0));
  ...
  hist.reset(evenCube->histogram(1));
  ...
  hist.reset(evenCube->histogram(2));
  ...
  hist.reset(evenCube->histogram(3));
  ...
  hist.reset(evenCube->histogram(4));
  ...
  hist.reset(evenCube->histogram(5));
